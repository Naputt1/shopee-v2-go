...
type FBSService interface {
	...
	QueryBrShopBlockStatus(ctx context.Context, sid uint64, mid uint64, tok string) (*QueryBrShopBlockStatusResponse, error)
	...
	QueryBrShopEnrollmentStatus(ctx context.Context, sid uint64, mid uint64, tok string) (*QueryBrShopEnrollmentStatusResponse, error)
	...
	QueryBrShopInvoiceError(ctx context.Context, sid uint64, mid uint64, tok string, req QueryBrShopInvoiceErrorRequest) (*QueryBrShopInvoiceErrorResponse, error)
	...
	QueryBrSkuBlockStatus(ctx context.Context, sid uint64, mid uint64, tok string, req QueryBrSkuBlockStatusRequest) (*QueryBrSkuBlockStatusResponse, error)
}
...
// Path: /api/v2/fbs/query_br_shop_block_status
// https://open.shopee.com/documents/v2/v2.fbs.query_br_shop_block_status?module=126&type=1
func (s *FBSServiceOp[T]) QueryBrShopBlockStatus(ctx context.Context, sid uint64, mid uint64, tok string) (*QueryBrShopBlockStatusResponse, error) {
...
// Path: /api/v2/fbs/query_br_shop_enrollment_status
// https://open.shopee.com/documents/v2/v2.fbs.query_br_shop_enrollment_status?module=126&type=1
func (s *FBSServiceOp[T]) QueryBrShopEnrollmentStatus(ctx context.Context, sid uint64, mid uint64, tok string) (*QueryBrShopEnrollmentStatusResponse, error) {
...
// Path: /api/v2/fbs/query_br_shop_invoice_error
// https://open.shopee.com/documents/v2/v2.fbs.query_br_shop_invoice_error?module=126&type=1
func (s *FBSServiceOp[T]) QueryBrShopInvoiceError(ctx context.Context, sid uint64, mid uint64, tok string, req QueryBrShopInvoiceErrorRequest) (*QueryBrShopInvoiceErrorResponse, error) {
...
// Path: /api/v2/fbs/query_br_sku_block_status
// https://open.shopee.com/documents/v2/v2.fbs.query_br_sku_block_status?module=126&type=1
func (s *FBSServiceOp[T]) QueryBrSkuBlockStatus(ctx context.Context, sid uint64, mid uint64, tok string, req QueryBrSkuBlockStatusRequest) (*QueryBrSkuBlockStatusResponse, error) {
