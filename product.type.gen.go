...
type GetModelListResponseDataModel struct {
	...
	PromotionId           uint64           `json:"promotion_id"`             // [Required] Current promotion ID of this model.
...
type SuccessPromotion struct {
	...
	PromotionId          uint64                `json:"promotion_id"`            // [Required] The identity of item promotion.
