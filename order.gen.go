...
type OrderService interface {
	...
	CancelOrder(ctx context.Context, sid uint64, req CancelOrderRequest, tok string) (*CancelOrderResponse, error)
	...
	DownloadFbsInvoices(ctx context.Context, sid uint64, req DownloadFbsInvoicesRequest, tok string) (*DownloadFbsInvoicesResponse, error)
	...
	DownloadInvoiceDoc(ctx context.Context, sid uint64, opt DownloadInvoiceDocRequest, tok string) (*DownloadInvoiceDocResponse, error)
	...
	GenerateFbsInvoices(ctx context.Context, sid uint64, req GenerateFbsInvoicesRequest, tok string) (*GenerateFbsInvoicesResponse, error)
	...
	GetBookingDetail(ctx context.Context, sid uint64, opt GetBookingDetailRequest, tok string) (*GetBookingDetailResponse, error)
	...
	GetBookingList(ctx context.Context, sid uint64, opt GetBookingListRequest, tok string) (*GetBookingListResponse, error)
	...
	GetBuyerInvoiceInfo(ctx context.Context, sid uint64, req GetBuyerInvoiceInfoRequest, tok string) (*GetBuyerInvoiceInfoResponse, error)
	...
	GetEstimateCancelValue(ctx context.Context, sid uint64, req GetEstimateCancelValueRequest, tok string) (*GetEstimateCancelValueResponse, error)
	...
	GetFbsInvoicesResult(ctx context.Context, sid uint64, req GetFbsInvoicesResultRequest, tok string) (*GetFbsInvoicesResultResponse, error)
	...
	GetOrderDetail(ctx context.Context, sid uint64, opt GetOrderDetailRequest, tok string) (*GetOrderDetailResponse, error)
	...
	GetOrderList(ctx context.Context, sid uint64, opt GetOrderListRequest, tok string) (*GetOrderListResponse, error)
	...
	GetPackageDetail(ctx context.Context, sid uint64, opt GetPackageDetailRequest, tok string) (*GetPackageDetailResponse, error)
	...
	GetPendingBuyerInvoiceOrderList(ctx context.Context, sid uint64, opt GetPendingBuyerInvoiceOrderListRequest, tok string) (*GetPendingBuyerInvoiceOrderListResponse, error)
	...
	GetShipmentList(ctx context.Context, sid uint64, opt GetShipmentListRequest, tok string) (*GetShipmentListResponse, error)
	...
	GetWarehouseFilterConfig(ctx context.Context, sid uint64, tok string) (*GetWarehouseFilterConfigResponse, error)
	...
	HandleBuyerCancellation(ctx context.Context, sid uint64, req HandleBuyerCancellationRequest, tok string) (*HandleBuyerCancellationResponse, error)
	...
	HandlePrescriptionCheck(ctx context.Context, sid uint64, req HandlePrescriptionCheckRequest, tok string) (*HandlePrescriptionCheckResponse, error)
	...
	SearchPackageList(ctx context.Context, sid uint64, req SearchPackageListRequest, tok string) (*SearchPackageListResponse, error)
	...
	SetNote(ctx context.Context, sid uint64, req SetNoteRequest, tok string) (*SetNoteResponse, error)
	...
	SplitOrder(ctx context.Context, sid uint64, req SplitOrderRequest, tok string) (*SplitOrderResponse, error)
	...
	UnsplitOrder(ctx context.Context, sid uint64, req UnsplitOrderRequest, tok string) (*UnsplitOrderResponse, error)
	...
	UploadInvoiceDoc(ctx context.Context, sid uint64, filename string, tok string) (*UploadInvoiceDocResponse, error)
	UploadInvoiceDocFromReader(ctx context.Context, sid uint64, filename string, reader io.Reader, tok string) (*UploadInvoiceDocResponse, error)
}
