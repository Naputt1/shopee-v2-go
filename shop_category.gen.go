...
type ShopCategoryService interface {
	...
	AddItemList(ctx context.Context, sid uint64, req ShopCategoryAddItemListRequest, tok string) (*ShopCategoryAddItemListResponse, error)
	...
	AddShopCategory(ctx context.Context, sid uint64, req AddShopCategoryRequest, tok string) (*AddShopCategoryResponse, error)
	...
	DeleteItemList(ctx context.Context, sid uint64, req ShopCategoryDeleteItemListRequest, tok string) (*ShopCategoryDeleteItemListResponse, error)
	...
	DeleteShopCategory(ctx context.Context, sid uint64, req DeleteShopCategoryRequest, tok string) (*DeleteShopCategoryResponse, error)
	...
	GetItemList(ctx context.Context, sid uint64, req ShopCategoryGetItemListRequest, tok string) (*ShopCategoryGetItemListResponse, error)
	...
	GetShopCategoryList(ctx context.Context, sid uint64, req GetShopCategoryListRequest, tok string) (*GetShopCategoryListResponse, error)
	...
	UpdateShopCategory(ctx context.Context, sid uint64, req UpdateShopCategoryRequest, tok string) (*UpdateShopCategoryResponse, error)
}
