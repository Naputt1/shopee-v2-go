...
type AccountHealthService interface {
	...
	GetLateOrders(ctx context.Context, sid uint64, opt GetLateOrdersRequest, tok string) (*GetLateOrdersResponse, error)
	...
	GetListingsWithIssues(ctx context.Context, sid uint64, opt GetListingsWithIssuesRequest, tok string) (*GetListingsWithIssuesResponse, error)
	...
	GetMetricSourceDetail(ctx context.Context, sid uint64, opt GetMetricSourceDetailRequest, tok string) (*GetMetricSourceDetailResponse, error)
	...
	GetPenaltyPointHistory(ctx context.Context, sid uint64, opt GetPenaltyPointHistoryRequest, tok string) (*GetPenaltyPointHistoryResponse, error)
	...
	GetPunishmentHistory(ctx context.Context, sid uint64, opt GetPunishmentHistoryRequest, tok string) (*GetPunishmentHistoryResponse, error)
	...
	GetShopPerformance(ctx context.Context, sid uint64, tok string) (*GetShopPerformanceResponse, error)
}
