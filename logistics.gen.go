...
type LogisticsService interface {
	...
	BatchShipOrder(ctx context.Context, sid uint64, mid uint64, tok string, req BatchShipOrderRequest) (*BatchShipOrderResponse, error)
	...
	BatchUpdateTpfWarehouseTrackingStatus(ctx context.Context, sid uint64, mid uint64, tok string, req BatchUpdateTpfWarehouseTrackingStatusRequest) (*BatchUpdateTpfWarehouseTrackingStatusResponse, error)
	...
	CheckPolygonUpdateStatus(ctx context.Context, sid uint64, mid uint64, tok string, req CheckPolygonUpdateStatusRequest) (*CheckPolygonUpdateStatusResponse, error)
	...
	CreateBookingShippingDocument(ctx context.Context, sid uint64, mid uint64, tok string, req CreateBookingShippingDocumentRequest) (*CreateBookingShippingDocumentResponse, error)
	...
	CreateShippingDocument(ctx context.Context, sid uint64, mid uint64, tok string, req CreateShippingDocumentRequest) (*CreateShippingDocumentResponse, error)
	...
	CreateShippingDocumentJob(ctx context.Context, sid uint64, mid uint64, tok string, req CreateShippingDocumentJobRequest) (*CreateShippingDocumentJobResponse, error)
	...
	DeleteAddress(ctx context.Context, sid uint64, mid uint64, tok string, req DeleteAddressRequest) (*DeleteAddressResponse, error)
	...
	DeleteSpecialOperatingHour(ctx context.Context, sid uint64, mid uint64, tok string, req DeleteSpecialOperatingHourRequest) (*DeleteSpecialOperatingHourResponse, error)
	...
	DownloadBookingShippingDocument(ctx context.Context, sid uint64, mid uint64, tok string, req DownloadBookingShippingDocumentRequest) (*DownloadBookingShippingDocumentResponse, error)
	...
	DownloadShippingDocument(ctx context.Context, sid uint64, mid uint64, tok string, req DownloadShippingDocumentRequest) (*DownloadShippingDocumentResponse, error)
	...
	DownloadShippingDocumentJob(ctx context.Context, sid uint64, mid uint64, tok string, req DownloadShippingDocumentJobRequest) (*DownloadShippingDocumentJobResponse, error)
	...
	DownloadToLabel(ctx context.Context, sid uint64, mid uint64, tok string, req DownloadToLabelRequest) (*DownloadToLabelResponse, error)
	...
	GetAddressList(ctx context.Context, sid uint64, mid uint64, tok string) (*GetAddressListResponse, error)
	...
	GetBookingShippingDocumentDataInfo(ctx context.Context, sid uint64, mid uint64, tok string, req GetBookingShippingDocumentDataInfoRequest) (*GetBookingShippingDocumentDataInfoResponse, error)
	...
	GetBookingShippingDocumentParameter(ctx context.Context, sid uint64, mid uint64, tok string, req GetBookingShippingDocumentParameterRequest) (*GetBookingShippingDocumentParameterResponse, error)
	...
	GetBookingShippingDocumentResult(ctx context.Context, sid uint64, mid uint64, tok string, req GetBookingShippingDocumentResultRequest) (*GetBookingShippingDocumentResultResponse, error)
	...
	GetBookingShippingParameter(ctx context.Context, sid uint64, mid uint64, tok string, opt GetBookingShippingParameterRequest) (*GetBookingShippingParameterResponse, error)
	...
	GetBookingTrackingInfo(ctx context.Context, sid uint64, mid uint64, tok string, opt GetBookingTrackingInfoRequest) (*GetBookingTrackingInfoResponse, error)
	...
	GetBookingTrackingNumber(ctx context.Context, sid uint64, mid uint64, tok string, opt GetBookingTrackingNumberRequest) (*GetBookingTrackingNumberResponse, error)
	...
	GetChannelList(ctx context.Context, sid uint64, mid uint64, tok string) (*LogisticsGetChannelListResponse, error)
	...
	GetMartPackagingInfo(ctx context.Context, sid uint64, mid uint64, tok string) (*GetMartPackagingInfoResponse, error)
	...
	GetMassShippingParameter(ctx context.Context, sid uint64, mid uint64, tok string, req GetMassShippingParameterRequest) (*GetMassShippingParameterResponse, error)
	...
	GetMassTrackingNumber(ctx context.Context, sid uint64, mid uint64, tok string, req GetMassTrackingNumberRequest) (*GetMassTrackingNumberResponse, error)
	...
	GetOperatingHourRestrictions(ctx context.Context, sid uint64, mid uint64, tok string) (*GetOperatingHourRestrictionsResponse, error)
	...
	GetOperatingHours(ctx context.Context, sid uint64, mid uint64, tok string) (*GetOperatingHoursResponse, error)
	...
	GetPauseStatus(ctx context.Context, sid uint64, mid uint64, tok string) (*GetPauseStatusResponse, error)
	...
	GetShippingDocumentDataInfo(ctx context.Context, sid uint64, mid uint64, tok string, req GetShippingDocumentDataInfoRequest) (*GetShippingDocumentDataInfoResponse, error)
	...
	GetShippingDocumentJobStatus(ctx context.Context, sid uint64, mid uint64, tok string, req GetShippingDocumentJobStatusRequest) (*GetShippingDocumentJobStatusResponse, error)
	...
	GetShippingDocumentParameter(ctx context.Context, sid uint64, mid uint64, tok string, req GetShippingDocumentParameterRequest) (*GetShippingDocumentParameterResponse, error)
	...
	GetShippingDocumentResult(ctx context.Context, sid uint64, mid uint64, tok string, req GetShippingDocumentResultRequest) (*GetShippingDocumentResultResponse, error)
	...
	GetShippingParameter(ctx context.Context, sid uint64, mid uint64, tok string, opt GetShippingParameterRequest) (*GetShippingParameterResponse, error)
	...
	GetTrackingInfo(ctx context.Context, sid uint64, mid uint64, tok string, opt GetTrackingInfoRequest) (*GetTrackingInfoResponse, error)
	...
	GetTrackingNumber(ctx context.Context, sid uint64, mid uint64, tok string, opt GetTrackingNumberRequest) (*GetTrackingNumberResponse, error)
	...
	MassShipOrder(ctx context.Context, sid uint64, mid uint64, tok string, req MassShipOrderRequest) (*MassShipOrderResponse, error)
	...
	SetAddressConfig(ctx context.Context, sid uint64, mid uint64, tok string, req SetAddressConfigRequest) (*SetAddressConfigResponse, error)
	...
	SetMartPackagingInfo(ctx context.Context, sid uint64, mid uint64, tok string, req SetMartPackagingInfoRequest) (*SetMartPackagingInfoResponse, error)
	...
	SetPauseStatus(ctx context.Context, sid uint64, mid uint64, tok string, req SetPauseStatusRequest) (*SetPauseStatusResponse, error)
	...
	ShipBooking(ctx context.Context, sid uint64, mid uint64, tok string, req ShipBookingRequest) (*ShipBookingResponse, error)
	...
	ShipOrder(ctx context.Context, sid uint64, mid uint64, tok string, req ShipOrderRequest) (*ShipOrderResponse, error)
	...
	UpdateAddress(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateAddressRequest) (*UpdateAddressResponse, error)
	...
	UpdateChannel(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateChannelRequest) (*UpdateChannelResponse, error)
	...
	UpdateOperatingHours(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateOperatingHoursRequest) (*UpdateOperatingHoursResponse, error)
	...
	UpdateSelfCollectionOrderLogistics(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateSelfCollectionOrderLogisticsRequest) (*UpdateSelfCollectionOrderLogisticsResponse, error)
	...
	UpdateShippingOrder(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateShippingOrderRequest) (*UpdateShippingOrderResponse, error)
	...
	UpdateTrackingStatus(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateTrackingStatusRequest) (*UpdateTrackingStatusResponse, error)
	...
	UploadServiceablePolygon(ctx context.Context, sid uint64, mid uint64, tok string, filename string) (*UploadServiceablePolygonResponse, error)
	UploadServiceablePolygonFromReader(ctx context.Context, sid uint64, mid uint64, tok string, filename string, reader io.Reader) (*UploadServiceablePolygonResponse, error)
}
...
// Path: /api/v2/logistics/batch_ship_order
// https://open.shopee.com/documents/v2/v2.logistics.batch_ship_order?module=95&type=1
func (s *LogisticsServiceOp[T]) BatchShipOrder(ctx context.Context, sid uint64, mid uint64, tok string, req BatchShipOrderRequest) (*BatchShipOrderResponse, error) {
...
// Path: /api/v2/logistics/batch_update_tpf_warehouse_tracking_status
// https://open.shopee.com/documents/v2/v2.logistics.batch_update_tpf_warehouse_tracking_status?module=95&type=1
func (s *LogisticsServiceOp[T]) BatchUpdateTpfWarehouseTrackingStatus(ctx context.Context, sid uint64, mid uint64, tok string, req BatchUpdateTpfWarehouseTrackingStatusRequest) (*BatchUpdateTpfWarehouseTrackingStatusResponse, error) {
...
// Path: /api/v2/logistics/check_polygon_update_status
// https://open.shopee.com/documents/v2/v2.logistics.check_polygon_update_status?module=95&type=1
func (s *LogisticsServiceOp[T]) CheckPolygonUpdateStatus(ctx context.Context, sid uint64, mid uint64, tok string, req CheckPolygonUpdateStatusRequest) (*CheckPolygonUpdateStatusResponse, error) {
...
// Path: /api/v2/logistics/create_booking_shipping_document
// https://open.shopee.com/documents/v2/v2.logistics.create_booking_shipping_document?module=95&type=1
func (s *LogisticsServiceOp[T]) CreateBookingShippingDocument(ctx context.Context, sid uint64, mid uint64, tok string, req CreateBookingShippingDocumentRequest) (*CreateBookingShippingDocumentResponse, error) {
...
// Path: /api/v2/logistics/create_shipping_document
// https://open.shopee.com/documents/v2/v2.logistics.create_shipping_document?module=95&type=1
func (s *LogisticsServiceOp[T]) CreateShippingDocument(ctx context.Context, sid uint64, mid uint64, tok string, req CreateShippingDocumentRequest) (*CreateShippingDocumentResponse, error) {
...
// Path: /api/v2/logistics/create_shipping_document_job
// https://open.shopee.com/documents/v2/v2.logistics.create_shipping_document_job?module=95&type=1
func (s *LogisticsServiceOp[T]) CreateShippingDocumentJob(ctx context.Context, sid uint64, mid uint64, tok string, req CreateShippingDocumentJobRequest) (*CreateShippingDocumentJobResponse, error) {
...
// Path: /api/v2/logistics/delete_address
// https://open.shopee.com/documents/v2/v2.logistics.delete_address?module=95&type=1
func (s *LogisticsServiceOp[T]) DeleteAddress(ctx context.Context, sid uint64, mid uint64, tok string, req DeleteAddressRequest) (*DeleteAddressResponse, error) {
...
// Path: /api/v2/logistics/delete_special_operating_hour
// https://open.shopee.com/documents/v2/v2.logistics.delete_special_operating_hour?module=95&type=1
func (s *LogisticsServiceOp[T]) DeleteSpecialOperatingHour(ctx context.Context, sid uint64, mid uint64, tok string, req DeleteSpecialOperatingHourRequest) (*DeleteSpecialOperatingHourResponse, error) {
...
// Path: /api/v2/logistics/download_booking_shipping_document
// https://open.shopee.com/documents/v2/v2.logistics.download_booking_shipping_document?module=95&type=1
func (s *LogisticsServiceOp[T]) DownloadBookingShippingDocument(ctx context.Context, sid uint64, mid uint64, tok string, req DownloadBookingShippingDocumentRequest) (*DownloadBookingShippingDocumentResponse, error) {
...
// Path: /api/v2/logistics/download_shipping_document
// https://open.shopee.com/documents/v2/v2.logistics.download_shipping_document?module=95&type=1
func (s *LogisticsServiceOp[T]) DownloadShippingDocument(ctx context.Context, sid uint64, mid uint64, tok string, req DownloadShippingDocumentRequest) (*DownloadShippingDocumentResponse, error) {
...
// Path: /api/v2/logistics/download_shipping_document_job
// https://open.shopee.com/documents/v2/v2.logistics.download_shipping_document_job?module=95&type=1
func (s *LogisticsServiceOp[T]) DownloadShippingDocumentJob(ctx context.Context, sid uint64, mid uint64, tok string, req DownloadShippingDocumentJobRequest) (*DownloadShippingDocumentJobResponse, error) {
...
// Path: /api/v2/logistics/download_to_label
// https://open.shopee.com/documents/v2/v2.logistics.download_to_label?module=95&type=1
func (s *LogisticsServiceOp[T]) DownloadToLabel(ctx context.Context, sid uint64, mid uint64, tok string, req DownloadToLabelRequest) (*DownloadToLabelResponse, error) {
...
// Path: /api/v2/logistics/get_address_list
// https://open.shopee.com/documents/v2/v2.logistics.get_address_list?module=95&type=1
func (s *LogisticsServiceOp[T]) GetAddressList(ctx context.Context, sid uint64, mid uint64, tok string) (*GetAddressListResponse, error) {
...
// Path: /api/v2/logistics/get_booking_shipping_document_data_info
// https://open.shopee.com/documents/v2/v2.logistics.get_booking_shipping_document_data_info?module=95&type=1
func (s *LogisticsServiceOp[T]) GetBookingShippingDocumentDataInfo(ctx context.Context, sid uint64, mid uint64, tok string, req GetBookingShippingDocumentDataInfoRequest) (*GetBookingShippingDocumentDataInfoResponse, error) {
...
// Path: /api/v2/logistics/get_booking_shipping_document_parameter
// https://open.shopee.com/documents/v2/v2.logistics.get_booking_shipping_document_parameter?module=95&type=1
func (s *LogisticsServiceOp[T]) GetBookingShippingDocumentParameter(ctx context.Context, sid uint64, mid uint64, tok string, req GetBookingShippingDocumentParameterRequest) (*GetBookingShippingDocumentParameterResponse, error) {
...
// Path: /api/v2/logistics/get_booking_shipping_document_result
// https://open.shopee.com/documents/v2/v2.logistics.get_booking_shipping_document_result?module=95&type=1
func (s *LogisticsServiceOp[T]) GetBookingShippingDocumentResult(ctx context.Context, sid uint64, mid uint64, tok string, req GetBookingShippingDocumentResultRequest) (*GetBookingShippingDocumentResultResponse, error) {
...
// Path: /api/v2/logistics/get_booking_shipping_parameter
// https://open.shopee.com/documents/v2/v2.logistics.get_booking_shipping_parameter?module=95&type=1
func (s *LogisticsServiceOp[T]) GetBookingShippingParameter(ctx context.Context, sid uint64, mid uint64, tok string, opt GetBookingShippingParameterRequest) (*GetBookingShippingParameterResponse, error) {
...
// Path: /api/v2/logistics/get_booking_tracking_info
// https://open.shopee.com/documents/v2/v2.logistics.get_booking_tracking_info?module=95&type=1
func (s *LogisticsServiceOp[T]) GetBookingTrackingInfo(ctx context.Context, sid uint64, mid uint64, tok string, opt GetBookingTrackingInfoRequest) (*GetBookingTrackingInfoResponse, error) {
...
// Path: /api/v2/logistics/get_booking_tracking_number
// https://open.shopee.com/documents/v2/v2.logistics.get_booking_tracking_number?module=95&type=1
func (s *LogisticsServiceOp[T]) GetBookingTrackingNumber(ctx context.Context, sid uint64, mid uint64, tok string, opt GetBookingTrackingNumberRequest) (*GetBookingTrackingNumberResponse, error) {
...
// Path: /api/v2/logistics/get_channel_list
// https://open.shopee.com/documents/v2/v2.logistics.get_channel_list?module=95&type=1
func (s *LogisticsServiceOp[T]) GetChannelList(ctx context.Context, sid uint64, mid uint64, tok string) (*LogisticsGetChannelListResponse, error) {
...
// Path: /api/v2/logistics/get_mart_packaging_info
// https://open.shopee.com/documents/v2/v2.logistics.get_mart_packaging_info?module=95&type=1
func (s *LogisticsServiceOp[T]) GetMartPackagingInfo(ctx context.Context, sid uint64, mid uint64, tok string) (*GetMartPackagingInfoResponse, error) {
...
// Path: /api/v2/logistics/get_mass_shipping_parameter
// https://open.shopee.com/documents/v2/v2.logistics.get_mass_shipping_parameter?module=95&type=1
func (s *LogisticsServiceOp[T]) GetMassShippingParameter(ctx context.Context, sid uint64, mid uint64, tok string, req GetMassShippingParameterRequest) (*GetMassShippingParameterResponse, error) {
...
// Path: /api/v2/logistics/get_mass_tracking_number
// https://open.shopee.com/documents/v2/v2.logistics.get_mass_tracking_number?module=95&type=1
func (s *LogisticsServiceOp[T]) GetMassTrackingNumber(ctx context.Context, sid uint64, mid uint64, tok string, req GetMassTrackingNumberRequest) (*GetMassTrackingNumberResponse, error) {
...
// Path: /api/v2/logistics/get_operating_hour_restrictions
// https://open.shopee.com/documents/v2/v2.logistics.get_operating_hour_restrictions?module=95&type=1
func (s *LogisticsServiceOp[T]) GetOperatingHourRestrictions(ctx context.Context, sid uint64, mid uint64, tok string) (*GetOperatingHourRestrictionsResponse, error) {
...
// Path: /api/v2/logistics/get_operating_hours
// https://open.shopee.com/documents/v2/v2.logistics.get_operating_hours?module=95&type=1
func (s *LogisticsServiceOp[T]) GetOperatingHours(ctx context.Context, sid uint64, mid uint64, tok string) (*GetOperatingHoursResponse, error) {
...
// Path: /api/v2/logistics/get_pause_status
// https://open.shopee.com/documents/v2/v2.logistics.get_pause_status?module=95&type=1
func (s *LogisticsServiceOp[T]) GetPauseStatus(ctx context.Context, sid uint64, mid uint64, tok string) (*GetPauseStatusResponse, error) {
...
// Path: /api/v2/logistics/get_shipping_document_data_info
// https://open.shopee.com/documents/v2/v2.logistics.get_shipping_document_data_info?module=95&type=1
func (s *LogisticsServiceOp[T]) GetShippingDocumentDataInfo(ctx context.Context, sid uint64, mid uint64, tok string, req GetShippingDocumentDataInfoRequest) (*GetShippingDocumentDataInfoResponse, error) {
...
// Path: /api/v2/logistics/get_shipping_document_job_status
// https://open.shopee.com/documents/v2/v2.logistics.get_shipping_document_job_status?module=95&type=1
func (s *LogisticsServiceOp[T]) GetShippingDocumentJobStatus(ctx context.Context, sid uint64, mid uint64, tok string, req GetShippingDocumentJobStatusRequest) (*GetShippingDocumentJobStatusResponse, error) {
...
// Path: /api/v2/logistics/get_shipping_document_parameter
// https://open.shopee.com/documents/v2/v2.logistics.get_shipping_document_parameter?module=95&type=1
func (s *LogisticsServiceOp[T]) GetShippingDocumentParameter(ctx context.Context, sid uint64, mid uint64, tok string, req GetShippingDocumentParameterRequest) (*GetShippingDocumentParameterResponse, error) {
...
// Path: /api/v2/logistics/get_shipping_document_result
// https://open.shopee.com/documents/v2/v2.logistics.get_shipping_document_result?module=95&type=1
func (s *LogisticsServiceOp[T]) GetShippingDocumentResult(ctx context.Context, sid uint64, mid uint64, tok string, req GetShippingDocumentResultRequest) (*GetShippingDocumentResultResponse, error) {
...
// Path: /api/v2/logistics/get_shipping_parameter
// https://open.shopee.com/documents/v2/v2.logistics.get_shipping_parameter?module=95&type=1
func (s *LogisticsServiceOp[T]) GetShippingParameter(ctx context.Context, sid uint64, mid uint64, tok string, opt GetShippingParameterRequest) (*GetShippingParameterResponse, error) {
...
// Path: /api/v2/logistics/get_tracking_info
// https://open.shopee.com/documents/v2/v2.logistics.get_tracking_info?module=95&type=1
func (s *LogisticsServiceOp[T]) GetTrackingInfo(ctx context.Context, sid uint64, mid uint64, tok string, opt GetTrackingInfoRequest) (*GetTrackingInfoResponse, error) {
...
// Path: /api/v2/logistics/get_tracking_number
// https://open.shopee.com/documents/v2/v2.logistics.get_tracking_number?module=95&type=1
func (s *LogisticsServiceOp[T]) GetTrackingNumber(ctx context.Context, sid uint64, mid uint64, tok string, opt GetTrackingNumberRequest) (*GetTrackingNumberResponse, error) {
...
// Path: /api/v2/logistics/mass_ship_order
// https://open.shopee.com/documents/v2/v2.logistics.mass_ship_order?module=95&type=1
func (s *LogisticsServiceOp[T]) MassShipOrder(ctx context.Context, sid uint64, mid uint64, tok string, req MassShipOrderRequest) (*MassShipOrderResponse, error) {
...
// Path: /api/v2/logistics/set_address_config
// https://open.shopee.com/documents/v2/v2.logistics.set_address_config?module=95&type=1
func (s *LogisticsServiceOp[T]) SetAddressConfig(ctx context.Context, sid uint64, mid uint64, tok string, req SetAddressConfigRequest) (*SetAddressConfigResponse, error) {
...
// Path: /api/v2/logistics/set_mart_packaging_info
// https://open.shopee.com/documents/v2/v2.logistics.set_mart_packaging_info?module=95&type=1
func (s *LogisticsServiceOp[T]) SetMartPackagingInfo(ctx context.Context, sid uint64, mid uint64, tok string, req SetMartPackagingInfoRequest) (*SetMartPackagingInfoResponse, error) {
...
// Path: /api/v2/logistics/set_pause_status
// https://open.shopee.com/documents/v2/v2.logistics.set_pause_status?module=95&type=1
func (s *LogisticsServiceOp[T]) SetPauseStatus(ctx context.Context, sid uint64, mid uint64, tok string, req SetPauseStatusRequest) (*SetPauseStatusResponse, error) {
...
// Path: /api/v2/logistics/ship_booking
// https://open.shopee.com/documents/v2/v2.logistics.ship_booking?module=95&type=1
func (s *LogisticsServiceOp[T]) ShipBooking(ctx context.Context, sid uint64, mid uint64, tok string, req ShipBookingRequest) (*ShipBookingResponse, error) {
...
// Path: /api/v2/logistics/ship_order
// https://open.shopee.com/documents/v2/v2.logistics.ship_order?module=95&type=1
func (s *LogisticsServiceOp[T]) ShipOrder(ctx context.Context, sid uint64, mid uint64, tok string, req ShipOrderRequest) (*ShipOrderResponse, error) {
...
// Path: /api/v2/logistics/update_address
// https://open.shopee.com/documents/v2/v2.logistics.update_address?module=95&type=1
func (s *LogisticsServiceOp[T]) UpdateAddress(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateAddressRequest) (*UpdateAddressResponse, error) {
...
// Path: /api/v2/logistics/update_channel
// https://open.shopee.com/documents/v2/v2.logistics.update_channel?module=95&type=1
func (s *LogisticsServiceOp[T]) UpdateChannel(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateChannelRequest) (*UpdateChannelResponse, error) {
...
// Path: /api/v2/logistics/update_operating_hours
// https://open.shopee.com/documents/v2/v2.logistics.update_operating_hours?module=95&type=1
func (s *LogisticsServiceOp[T]) UpdateOperatingHours(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateOperatingHoursRequest) (*UpdateOperatingHoursResponse, error) {
...
// Path: /api/v2/logistics/update_self_collection_order_logistics
// https://open.shopee.com/documents/v2/v2.logistics.update_self_collection_order_logistics?module=95&type=1
func (s *LogisticsServiceOp[T]) UpdateSelfCollectionOrderLogistics(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateSelfCollectionOrderLogisticsRequest) (*UpdateSelfCollectionOrderLogisticsResponse, error) {
...
// Path: /api/v2/logistics/update_shipping_order
// https://open.shopee.com/documents/v2/v2.logistics.update_shipping_order?module=95&type=1
func (s *LogisticsServiceOp[T]) UpdateShippingOrder(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateShippingOrderRequest) (*UpdateShippingOrderResponse, error) {
...
// Path: /api/v2/logistics/update_tracking_status
// https://open.shopee.com/documents/v2/v2.logistics.update_tracking_status?module=95&type=1
func (s *LogisticsServiceOp[T]) UpdateTrackingStatus(ctx context.Context, sid uint64, mid uint64, tok string, req UpdateTrackingStatusRequest) (*UpdateTrackingStatusResponse, error) {
...
// Path: /api/v2/logistics/upload_serviceable_polygon
// https://open.shopee.com/documents/v2/v2.logistics.upload_serviceable_polygon?module=95&type=1
func (s *LogisticsServiceOp[T]) UploadServiceablePolygon(ctx context.Context, sid uint64, mid uint64, tok string, filename string) (*UploadServiceablePolygonResponse, error) {
...
func (s *LogisticsServiceOp[T]) UploadServiceablePolygonFromReader(ctx context.Context, sid uint64, mid uint64, tok string, filename string, reader io.Reader) (*UploadServiceablePolygonResponse, error) {
	path := "/logistics/upload_serviceable_polygon"
	resp := new(UploadServiceablePolygonResponse)
