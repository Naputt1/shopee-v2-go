...
type LogisticsService interface {
	...
	BatchShipOrder(ctx context.Context, sid uint64, req BatchShipOrderRequest, tok string) (*BatchShipOrderResponse, error)
	...
	BatchUpdateTpfWarehouseTrackingStatus(ctx context.Context, sid uint64, req BatchUpdateTpfWarehouseTrackingStatusRequest, tok string) (*BatchUpdateTpfWarehouseTrackingStatusResponse, error)
	...
	CheckPolygonUpdateStatus(ctx context.Context, sid uint64, req CheckPolygonUpdateStatusRequest, tok string) (*CheckPolygonUpdateStatusResponse, error)
	...
	CreateBookingShippingDocument(ctx context.Context, sid uint64, req CreateBookingShippingDocumentRequest, tok string) (*CreateBookingShippingDocumentResponse, error)
	...
	CreateShippingDocument(ctx context.Context, sid uint64, req CreateShippingDocumentRequest, tok string) (*CreateShippingDocumentResponse, error)
	...
	CreateShippingDocumentJob(ctx context.Context, sid uint64, req CreateShippingDocumentJobRequest, tok string) (*CreateShippingDocumentJobResponse, error)
	...
	DeleteAddress(ctx context.Context, sid uint64, req DeleteAddressRequest, tok string) (*DeleteAddressResponse, error)
	...
	DeleteSpecialOperatingHour(ctx context.Context, sid uint64, req DeleteSpecialOperatingHourRequest, tok string) (*DeleteSpecialOperatingHourResponse, error)
	...
	DownloadBookingShippingDocument(ctx context.Context, sid uint64, req DownloadBookingShippingDocumentRequest, tok string) (*DownloadBookingShippingDocumentResponse, error)
	...
	DownloadShippingDocument(ctx context.Context, sid uint64, req DownloadShippingDocumentRequest, tok string) (*DownloadShippingDocumentResponse, error)
	...
	DownloadShippingDocumentJob(ctx context.Context, sid uint64, req DownloadShippingDocumentJobRequest, tok string) (*DownloadShippingDocumentJobResponse, error)
	...
	DownloadToLabel(ctx context.Context, sid uint64, req DownloadToLabelRequest, tok string) (*DownloadToLabelResponse, error)
	...
	GetAddressList(ctx context.Context, sid uint64, tok string) (*GetAddressListResponse, error)
	...
	GetBookingShippingDocumentDataInfo(ctx context.Context, sid uint64, req GetBookingShippingDocumentDataInfoRequest, tok string) (*GetBookingShippingDocumentDataInfoResponse, error)
	...
	GetBookingShippingDocumentParameter(ctx context.Context, sid uint64, req GetBookingShippingDocumentParameterRequest, tok string) (*GetBookingShippingDocumentParameterResponse, error)
	...
	GetBookingShippingDocumentResult(ctx context.Context, sid uint64, req GetBookingShippingDocumentResultRequest, tok string) (*GetBookingShippingDocumentResultResponse, error)
	...
	GetBookingShippingParameter(ctx context.Context, sid uint64, opt GetBookingShippingParameterRequest, tok string) (*GetBookingShippingParameterResponse, error)
	...
	GetBookingTrackingInfo(ctx context.Context, sid uint64, opt GetBookingTrackingInfoRequest, tok string) (*GetBookingTrackingInfoResponse, error)
	...
	GetBookingTrackingNumber(ctx context.Context, sid uint64, opt GetBookingTrackingNumberRequest, tok string) (*GetBookingTrackingNumberResponse, error)
	...
	GetChannelList(ctx context.Context, sid uint64, tok string) (*LogisticsGetChannelListResponse, error)
	...
	GetMartPackagingInfo(ctx context.Context, sid uint64, tok string) (*GetMartPackagingInfoResponse, error)
	...
	GetMassShippingParameter(ctx context.Context, sid uint64, req GetMassShippingParameterRequest, tok string) (*GetMassShippingParameterResponse, error)
	...
	GetMassTrackingNumber(ctx context.Context, sid uint64, req GetMassTrackingNumberRequest, tok string) (*GetMassTrackingNumberResponse, error)
	...
	GetOperatingHourRestrictions(ctx context.Context, sid uint64, tok string) (*GetOperatingHourRestrictionsResponse, error)
	...
	GetOperatingHours(ctx context.Context, sid uint64, tok string) (*GetOperatingHoursResponse, error)
	...
	GetPauseStatus(ctx context.Context, sid uint64, tok string) (*GetPauseStatusResponse, error)
	...
	GetShippingDocumentDataInfo(ctx context.Context, sid uint64, req GetShippingDocumentDataInfoRequest, tok string) (*GetShippingDocumentDataInfoResponse, error)
	...
	GetShippingDocumentJobStatus(ctx context.Context, sid uint64, req GetShippingDocumentJobStatusRequest, tok string) (*GetShippingDocumentJobStatusResponse, error)
	...
	GetShippingDocumentParameter(ctx context.Context, sid uint64, req GetShippingDocumentParameterRequest, tok string) (*GetShippingDocumentParameterResponse, error)
	...
	GetShippingDocumentResult(ctx context.Context, sid uint64, req GetShippingDocumentResultRequest, tok string) (*GetShippingDocumentResultResponse, error)
	...
	GetShippingParameter(ctx context.Context, sid uint64, opt GetShippingParameterRequest, tok string) (*GetShippingParameterResponse, error)
	...
	GetTrackingInfo(ctx context.Context, sid uint64, opt GetTrackingInfoRequest, tok string) (*GetTrackingInfoResponse, error)
	...
	GetTrackingNumber(ctx context.Context, sid uint64, opt GetTrackingNumberRequest, tok string) (*GetTrackingNumberResponse, error)
	...
	MassShipOrder(ctx context.Context, sid uint64, req MassShipOrderRequest, tok string) (*MassShipOrderResponse, error)
	...
	SetAddressConfig(ctx context.Context, sid uint64, req SetAddressConfigRequest, tok string) (*SetAddressConfigResponse, error)
	...
	SetMartPackagingInfo(ctx context.Context, sid uint64, req SetMartPackagingInfoRequest, tok string) (*SetMartPackagingInfoResponse, error)
	...
	SetPauseStatus(ctx context.Context, sid uint64, req SetPauseStatusRequest, tok string) (*SetPauseStatusResponse, error)
	...
	ShipBooking(ctx context.Context, sid uint64, req ShipBookingRequest, tok string) (*ShipBookingResponse, error)
	...
	ShipOrder(ctx context.Context, sid uint64, req ShipOrderRequest, tok string) (*ShipOrderResponse, error)
	...
	UpdateAddress(ctx context.Context, sid uint64, req UpdateAddressRequest, tok string) (*UpdateAddressResponse, error)
	...
	UpdateChannel(ctx context.Context, sid uint64, req UpdateChannelRequest, tok string) (*UpdateChannelResponse, error)
	...
	UpdateOperatingHours(ctx context.Context, sid uint64, req UpdateOperatingHoursRequest, tok string) (*UpdateOperatingHoursResponse, error)
	...
	UpdateSelfCollectionOrderLogistics(ctx context.Context, sid uint64, req UpdateSelfCollectionOrderLogisticsRequest, tok string) (*UpdateSelfCollectionOrderLogisticsResponse, error)
	...
	UpdateShippingOrder(ctx context.Context, sid uint64, req UpdateShippingOrderRequest, tok string) (*UpdateShippingOrderResponse, error)
	...
	UpdateTrackingStatus(ctx context.Context, sid uint64, req UpdateTrackingStatusRequest, tok string) (*UpdateTrackingStatusResponse, error)
	...
	UploadServiceablePolygon(ctx context.Context, sid uint64, filename string, tok string) (*UploadServiceablePolygonResponse, error)
	UploadServiceablePolygonFromReader(ctx context.Context, sid uint64, filename string, reader io.Reader, tok string) (*UploadServiceablePolygonResponse, error)
}
