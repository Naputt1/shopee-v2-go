...
type PushService interface {
	...
	ConfirmConsumedLostPushMessage(ctx context.Context, sid uint64, mid uint64, tok string, req ConfirmConsumedLostPushMessageRequest) (*ConfirmConsumedLostPushMessageResponse, error)
	...
	GetAppPushConfig(ctx context.Context, sid uint64, mid uint64, tok string) (*GetAppPushConfigResponse, error)
	...
	GetLostPushMessage(ctx context.Context, sid uint64, mid uint64, tok string) (*GetLostPushMessageResponse, error)
	...
	SetAppPushConfig(ctx context.Context, sid uint64, mid uint64, tok string, req SetAppPushConfigRequest) (*SetAppPushConfigResponse, error)
}
...
// Path: /api/v2/push/confirm_consumed_lost_push_message
// https://open.shopee.com/documents/v2/v2.push.confirm_consumed_lost_push_message?module=105&type=1
func (s *PushServiceOp[T]) ConfirmConsumedLostPushMessage(ctx context.Context, sid uint64, mid uint64, tok string, req ConfirmConsumedLostPushMessageRequest) (*ConfirmConsumedLostPushMessageResponse, error) {
...
// Path: /api/v2/push/get_app_push_config
// https://open.shopee.com/documents/v2/v2.push.get_app_push_config?module=105&type=1
func (s *PushServiceOp[T]) GetAppPushConfig(ctx context.Context, sid uint64, mid uint64, tok string) (*GetAppPushConfigResponse, error) {
...
// Path: /api/v2/push/get_lost_push_message
// https://open.shopee.com/documents/v2/v2.push.get_lost_push_message?module=105&type=1
func (s *PushServiceOp[T]) GetLostPushMessage(ctx context.Context, sid uint64, mid uint64, tok string) (*GetLostPushMessageResponse, error) {
...
// Path: /api/v2/push/set_app_push_config
// https://open.shopee.com/documents/v2/v2.push.set_app_push_config?module=105&type=1
func (s *PushServiceOp[T]) SetAppPushConfig(ctx context.Context, sid uint64, mid uint64, tok string, req SetAppPushConfigRequest) (*SetAppPushConfigResponse, error) {
