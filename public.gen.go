...
type PublicService interface {
	...
	GetMerchantsByPartner(ctx context.Context, sid uint64, mid uint64, tok string, opt GetMerchantsByPartnerRequest) (*GetMerchantsByPartnerResponse, error)
	...
	GetShopeeIpRanges(ctx context.Context, sid uint64, mid uint64, tok string) (*GetShopeeIpRangesResponse, error)
	...
	GetShopsByPartner(ctx context.Context, sid uint64, mid uint64, tok string, opt GetShopsByPartnerRequest) (*GetShopsByPartnerResponse, error)
	...
	GetTokenByResendCode(ctx context.Context, sid uint64, mid uint64, tok string, req GetTokenByResendCodeRequest) (*GetTokenByResendCodeResponse, error)
}
...
// Path: /api/v2/public/get_merchants_by_partner
// https://open.shopee.com/documents/v2/v2.public.get_merchants_by_partner?module=104&type=1
func (s *PublicServiceOp[T]) GetMerchantsByPartner(ctx context.Context, sid uint64, mid uint64, tok string, opt GetMerchantsByPartnerRequest) (*GetMerchantsByPartnerResponse, error) {
...
// Path: /api/v2/public/get_shopee_ip_ranges
// https://open.shopee.com/documents/v2/v2.public.get_shopee_ip_ranges?module=104&type=1
func (s *PublicServiceOp[T]) GetShopeeIpRanges(ctx context.Context, sid uint64, mid uint64, tok string) (*GetShopeeIpRangesResponse, error) {
...
// Path: /api/v2/public/get_shops_by_partner
// https://open.shopee.com/documents/v2/v2.public.get_shops_by_partner?module=104&type=1
func (s *PublicServiceOp[T]) GetShopsByPartner(ctx context.Context, sid uint64, mid uint64, tok string, opt GetShopsByPartnerRequest) (*GetShopsByPartnerResponse, error) {
...
// Path: /api/v2/public/get_token_by_resend_code
// https://open.shopee.com/documents/v2/v2.public.get_token_by_resend_code?module=104&type=1
func (s *PublicServiceOp[T]) GetTokenByResendCode(ctx context.Context, sid uint64, mid uint64, tok string, req GetTokenByResendCodeRequest) (*GetTokenByResendCodeResponse, error) {
