...
type ShopService interface {
	...
	GetAuthorisedResellerBrand(ctx context.Context, sid uint64, opt GetAuthorisedResellerBrandRequest, tok string) (*GetAuthorisedResellerBrandResponse, error)
	...
	GetBrShopOnboardingInfo(ctx context.Context, sid uint64, tok string) (*GetBrShopOnboardingInfoResponse, error)
	...
	GetProfile(ctx context.Context, sid uint64, tok string) (*GetProfileResponse, error)
	...
	GetShopHolidayMode(ctx context.Context, sid uint64, tok string) (*GetShopHolidayModeResponse, error)
	...
	GetShopInfo(ctx context.Context, sid uint64, tok string) (*GetShopInfoResponse, error)
	...
	GetShopNotification(ctx context.Context, sid uint64, opt GetShopNotificationRequest, tok string) (*GetShopNotificationResponse, error)
	...
	GetWarehouseDetail(ctx context.Context, sid uint64, opt GetWarehouseDetailRequest, tok string) (*GetWarehouseDetailResponse, error)
	...
	SetShopHolidayMode(ctx context.Context, sid uint64, req SetShopHolidayModeRequest, tok string) (*SetShopHolidayModeResponse, error)
	...
	UpdateProfile(ctx context.Context, sid uint64, req UpdateProfileRequest, tok string) (*UpdateProfileResponse, error)
}
