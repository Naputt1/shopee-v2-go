...
type AdsService interface {
	...
	CheckCreateGmsProductCampaignEligibility(ctx context.Context, sid uint64, tok string) (*CheckCreateGmsProductCampaignEligibilityResponse, error)
	...
	CreateGmsProductCampaign(ctx context.Context, sid uint64, req CreateGmsProductCampaignRequest, tok string) (*CreateGmsProductCampaignResponse, error)
	...
	CreateManualProductAds(ctx context.Context, sid uint64, req CreateManualProductAdsRequest, tok string) (*CreateManualProductAdsResponse, error)
	...
	EditGmsItemProductCampaign(ctx context.Context, sid uint64, req EditGmsItemProductCampaignRequest, tok string) (*EditGmsItemProductCampaignResponse, error)
	...
	EditGmsProductCampaign(ctx context.Context, sid uint64, req EditGmsProductCampaignRequest, tok string) (*EditGmsProductCampaignResponse, error)
	...
	EditManualProductAdKeywords(ctx context.Context, sid uint64, req EditManualProductAdKeywordsRequest, tok string) (*EditManualProductAdKeywordsResponse, error)
	...
	EditManualProductAds(ctx context.Context, sid uint64, req EditManualProductAdsRequest, tok string) (*EditManualProductAdsResponse, error)
	...
	GetAdsFcilShopRate(ctx context.Context, sid uint64, tok string) (*GetAdsFcilShopRateResponse, error)
	...
	GetAllCpcAdsDailyPerformance(ctx context.Context, sid uint64, opt GetAllCpcAdsDailyPerformanceRequest, tok string) (*GetAllCpcAdsDailyPerformanceResponse, error)
	...
	GetAllCpcAdsHourlyPerformance(ctx context.Context, sid uint64, opt GetAllCpcAdsHourlyPerformanceRequest, tok string) (*GetAllCpcAdsHourlyPerformanceResponse, error)
	...
	GetCreateProductAdBudgetSuggestion(ctx context.Context, sid uint64, opt GetCreateProductAdBudgetSuggestionRequest, tok string) (*GetCreateProductAdBudgetSuggestionResponse, error)
	...
	GetGmsCampaignPerformance(ctx context.Context, sid uint64, req GetGmsCampaignPerformanceRequest, tok string) (*GetGmsCampaignPerformanceResponse, error)
	...
	GetGmsItemPerformance(ctx context.Context, sid uint64, req GetGmsItemPerformanceRequest, tok string) (*GetGmsItemPerformanceResponse, error)
	...
	GetProductCampaignDailyPerformance(ctx context.Context, sid uint64, opt GetProductCampaignDailyPerformanceRequest, tok string) (*GetProductCampaignDailyPerformanceResponse, error)
	...
	GetProductCampaignHourlyPerformance(ctx context.Context, sid uint64, opt GetProductCampaignHourlyPerformanceRequest, tok string) (*GetProductCampaignHourlyPerformanceResponse, error)
	...
	GetProductLevelCampaignIdList(ctx context.Context, sid uint64, opt GetProductLevelCampaignIdListRequest, tok string) (*GetProductLevelCampaignIdListResponse, error)
	...
	GetProductLevelCampaignSettingInfo(ctx context.Context, sid uint64, opt GetProductLevelCampaignSettingInfoRequest, tok string) (*GetProductLevelCampaignSettingInfoResponse, error)
	...
	GetProductRecommendedRoiTarget(ctx context.Context, sid uint64, opt GetProductRecommendedRoiTargetRequest, tok string) (*GetProductRecommendedRoiTargetResponse, error)
	...
	GetRecommendedItemList(ctx context.Context, sid uint64, tok string) (*GetRecommendedItemListResponse, error)
	...
	GetRecommendedKeywordList(ctx context.Context, sid uint64, opt GetRecommendedKeywordListRequest, tok string) (*GetRecommendedKeywordListResponse, error)
	...
	GetShopToggleInfo(ctx context.Context, sid uint64, tok string) (*GetShopToggleInfoResponse, error)
	...
	GetTotalBalance(ctx context.Context, sid uint64, tok string) (*GetTotalBalanceResponse, error)
	...
	ListGmsUserDeletedItem(ctx context.Context, sid uint64, req ListGmsUserDeletedItemRequest, tok string) (*ListGmsUserDeletedItemResponse, error)
}
