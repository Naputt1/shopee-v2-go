...
type ProductService interface {
	...
	CategoryRecommend(sid uint64, opt ProductCategoryRecommendRequest, tok string) (*ProductCategoryRecommendResponse, error)
	...
	GetAttributeTree(sid uint64, opt ProductGetAttributeTreeRequest, tok string) (*ProductGetAttributeTreeResponse, error)
	...
	GetBrandList(sid uint64, opt ProductGetBrandListRequest, tok string) (*ProductGetBrandListResponse, error)
	...
	GetCategory(sid uint64, opt ProductGetCategoryRequest, tok string) (*ProductGetCategoryResponse, error)
	...
	GetItemList(sid uint64, opt ProductGetItemListRequest, tok string) (*ProductGetItemListResponse, error)
	...
	GetRecommendAttribute(sid uint64, opt ProductGetRecommendAttributeRequest, tok string) (*ProductGetRecommendAttributeResponse, error)
	...
	GetSizeChartDetail(sid uint64, opt ProductGetSizeChartDetailRequest, tok string) (*ProductGetSizeChartDetailResponse, error)
	...
	GetVariations(sid uint64, opt ProductGetVariationsRequest, tok string) (*ProductGetVariationsResponse, error)
	...
	UpdatePrice(sid uint64, req ProductUpdatePriceRequest, tok string) (*ProductUpdatePriceResponse, error)
	...
	UpdateStock(sid uint64, req ProductUpdateStockRequest, tok string) (*ProductUpdateStockResponse, error)
	...
	UpdateTierVariation(sid uint64, req ProductUpdateTierVariationRequest, tok string) (*ProductUpdateTierVariationResponse, error)
}
...
// Path: /api/v2/product/category_recommend
// https://open.shopee.com/documents/v2/v2.product.category_recommend?module=89&type=1
func (s *ProductServiceOp[T]) CategoryRecommend(sid uint64, opt ProductCategoryRecommendRequest, tok string) (*ProductCategoryRecommendResponse, error) {
...
// Path: /api/v2/product/get_attribute_tree
// https://open.shopee.com/documents/v2/v2.product.get_attribute_tree?module=89&type=1
func (s *ProductServiceOp[T]) GetAttributeTree(sid uint64, opt ProductGetAttributeTreeRequest, tok string) (*ProductGetAttributeTreeResponse, error) {
...
// Path: /api/v2/product/get_brand_list
// https://open.shopee.com/documents/v2/v2.product.get_brand_list?module=89&type=1
func (s *ProductServiceOp[T]) GetBrandList(sid uint64, opt ProductGetBrandListRequest, tok string) (*ProductGetBrandListResponse, error) {
...
// Path: /api/v2/product/get_category
// https://open.shopee.com/documents/v2/v2.product.get_category?module=89&type=1
func (s *ProductServiceOp[T]) GetCategory(sid uint64, opt ProductGetCategoryRequest, tok string) (*ProductGetCategoryResponse, error) {
...
// Path: /api/v2/product/get_item_list
// https://open.shopee.com/documents/v2/v2.product.get_item_list?module=89&type=1
func (s *ProductServiceOp[T]) GetItemList(sid uint64, opt ProductGetItemListRequest, tok string) (*ProductGetItemListResponse, error) {
...
// Path: /api/v2/product/get_recommend_attribute
// https://open.shopee.com/documents/v2/v2.product.get_recommend_attribute?module=89&type=1
func (s *ProductServiceOp[T]) GetRecommendAttribute(sid uint64, opt ProductGetRecommendAttributeRequest, tok string) (*ProductGetRecommendAttributeResponse, error) {
...
// Path: /api/v2/product/get_size_chart_detail
// https://open.shopee.com/documents/v2/v2.product.get_size_chart_detail?module=89&type=1
func (s *ProductServiceOp[T]) GetSizeChartDetail(sid uint64, opt ProductGetSizeChartDetailRequest, tok string) (*ProductGetSizeChartDetailResponse, error) {
...
// Path: /api/v2/product/get_size_chart_list
// https://open.shopee.com/documents/v2/v2.product.get_size_chart_list?module=89&type=1
func (s *ProductServiceOp[T]) GetSizeChartList(sid uint64, opt ProductGetSizeChartListRequest, tok string) (*ProductGetSizeChartListResponse, error) {
...
// Path: /api/v2/product/get_variation_tree
// https://open.shopee.com/documents/v2/v2.product.get_variations?module=89&type=1
func (s *ProductServiceOp[T]) GetVariations(sid uint64, opt ProductGetVariationsRequest, tok string) (*ProductGetVariationsResponse, error) {
...
// Path: /api/v2/product/init_tier_variation
// https://open.shopee.com/documents/v2/v2.product.init_tier_variation?module=89&type=1
func (s *ProductServiceOp[T]) InitTierVariation(sid uint64, req ProductInitTierVariationRequest, tok string) (*ProductInitTierVariationResponse, error) {
...
// Path: /api/v2/product/update_price
// https://open.shopee.com/documents/v2/v2.product.update_price?module=89&type=1
func (s *ProductServiceOp[T]) UpdatePrice(sid uint64, req ProductUpdatePriceRequest, tok string) (*ProductUpdatePriceResponse, error) {
...
// Path: /api/v2/product/update_stock
// https://open.shopee.com/documents/v2/v2.product.update_stock?module=89&type=1
func (s *ProductServiceOp[T]) UpdateStock(sid uint64, req ProductUpdateStockRequest, tok string) (*ProductUpdateStockResponse, error) {
...
// Path: /api/v2/product/update_tier_variation
// https://open.shopee.com/documents/v2/v2.product.update_tier_variation?module=89&type=1
func (s *ProductServiceOp[T]) UpdateTierVariation(sid uint64, req ProductUpdateTierVariationRequest, tok string) (*ProductUpdateTierVariationResponse, error) {
