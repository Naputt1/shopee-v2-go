...
type AMSService interface {
	...
	AddAllProductsToOpenCampaign(ctx context.Context, sid uint64, req AddAllProductsToOpenCampaignRequest, tok string) (*AddAllProductsToOpenCampaignResponse, error)
	...
	BatchAddProductsToOpenCampaign(ctx context.Context, sid uint64, req BatchAddProductsToOpenCampaignRequest, tok string) (*BatchAddProductsToOpenCampaignResponse, error)
	...
	BatchEditProductsOpenCampaignSetting(ctx context.Context, sid uint64, req BatchEditProductsOpenCampaignSettingRequest, tok string) (*BatchEditProductsOpenCampaignSettingResponse, error)
	...
	BatchGetProductsSuggestedRate(ctx context.Context, sid uint64, opt BatchGetProductsSuggestedRateRequest, tok string) (*BatchGetProductsSuggestedRateResponse, error)
	...
	BatchRemoveProductsOpenCampaignSetting(ctx context.Context, sid uint64, req BatchRemoveProductsOpenCampaignSettingRequest, tok string) (*BatchRemoveProductsOpenCampaignSettingResponse, error)
	...
	CreateNewTargetedCampaign(ctx context.Context, sid uint64, req CreateNewTargetedCampaignRequest, tok string) (*CreateNewTargetedCampaignResponse, error)
	...
	EditAffiliateListOfTargetedCampaign(ctx context.Context, sid uint64, req EditAffiliateListOfTargetedCampaignRequest, tok string) (*EditAffiliateListOfTargetedCampaignResponse, error)
	...
	EditAllProductsOpenCampaignSetting(ctx context.Context, sid uint64, req EditAllProductsOpenCampaignSettingRequest, tok string) (*EditAllProductsOpenCampaignSettingResponse, error)
	...
	EditProductListOfTargetedCampaign(ctx context.Context, sid uint64, req EditProductListOfTargetedCampaignRequest, tok string) (*EditProductListOfTargetedCampaignResponse, error)
	...
	GetAffiliatePerformance(ctx context.Context, sid uint64, opt GetAffiliatePerformanceRequest, tok string) (*GetAffiliatePerformanceResponse, error)
	...
	GetAutoAddNewProductToggleStatus(ctx context.Context, sid uint64, tok string) (*GetAutoAddNewProductToggleStatusResponse, error)
	...
	GetCampaignKeyMetricsPerformance(ctx context.Context, sid uint64, opt GetCampaignKeyMetricsPerformanceRequest, tok string) (*GetCampaignKeyMetricsPerformanceResponse, error)
	...
	GetContentPerformance(ctx context.Context, sid uint64, opt GetContentPerformanceRequest, tok string) (*GetContentPerformanceResponse, error)
	...
	GetConversionReport(ctx context.Context, sid uint64, opt GetConversionReportRequest, tok string) (*GetConversionReportResponse, error)
	...
	GetManagedAffiliateList(ctx context.Context, sid uint64, opt GetManagedAffiliateListRequest, tok string) (*GetManagedAffiliateListResponse, error)
	...
	GetOpenCampaignAddedProduct(ctx context.Context, sid uint64, opt GetOpenCampaignAddedProductRequest, tok string) (*GetOpenCampaignAddedProductResponse, error)
	...
	GetOpenCampaignBatchTaskResult(ctx context.Context, sid uint64, opt GetOpenCampaignBatchTaskResultRequest, tok string) (*GetOpenCampaignBatchTaskResultResponse, error)
	...
	GetOpenCampaignNotAddedProduct(ctx context.Context, sid uint64, opt GetOpenCampaignNotAddedProductRequest, tok string) (*GetOpenCampaignNotAddedProductResponse, error)
	...
	GetOpenCampaignPerformance(ctx context.Context, sid uint64, opt GetOpenCampaignPerformanceRequest, tok string) (*GetOpenCampaignPerformanceResponse, error)
	...
	GetOptimizationSuggestionProduct(ctx context.Context, sid uint64, opt GetOptimizationSuggestionProductRequest, tok string) (*GetOptimizationSuggestionProductResponse, error)
	...
	GetPerformanceDataUpdateTime(ctx context.Context, sid uint64, opt GetPerformanceDataUpdateTimeRequest, tok string) (*GetPerformanceDataUpdateTimeResponse, error)
	...
	GetProductPerformance(ctx context.Context, sid uint64, opt GetProductPerformanceRequest, tok string) (*GetProductPerformanceResponse, error)
	...
	GetRecommendedAffiliateList(ctx context.Context, sid uint64, opt GetRecommendedAffiliateListRequest, tok string) (*GetRecommendedAffiliateListResponse, error)
	...
	GetShopPerformance(ctx context.Context, sid uint64, opt GetShopPerformanceRequest, tok string) (*AMSGetShopPerformanceResponse, error)
	...
	GetShopSuggestedRate(ctx context.Context, sid uint64, tok string) (*GetShopSuggestedRateResponse, error)
	...
	GetTargetedCampaignAddableProductList(ctx context.Context, sid uint64, opt GetTargetedCampaignAddableProductListRequest, tok string) (*GetTargetedCampaignAddableProductListResponse, error)
	...
	GetTargetedCampaignList(ctx context.Context, sid uint64, opt GetTargetedCampaignListRequest, tok string) (*GetTargetedCampaignListResponse, error)
	...
	GetTargetedCampaignPerformance(ctx context.Context, sid uint64, opt GetTargetedCampaignPerformanceRequest, tok string) (*GetTargetedCampaignPerformanceResponse, error)
	...
	GetTargetedCampaignSettings(ctx context.Context, sid uint64, opt GetTargetedCampaignSettingsRequest, tok string) (*GetTargetedCampaignSettingsResponse, error)
	...
	GetValidationList(ctx context.Context, sid uint64, tok string) (*GetValidationListResponse, error)
	...
	GetValidationReport(ctx context.Context, sid uint64, opt GetValidationReportRequest, tok string) (*GetValidationReportResponse, error)
	...
	QueryAffiliateList(ctx context.Context, sid uint64, opt QueryAffiliateListRequest, tok string) (*QueryAffiliateListResponse, error)
	...
	RemoveAllProductsOpenCampaignSetting(ctx context.Context, sid uint64, tok string) (*RemoveAllProductsOpenCampaignSettingResponse, error)
	...
	TerminateTargetedCampaign(ctx context.Context, sid uint64, req TerminateTargetedCampaignRequest, tok string) (*TerminateTargetedCampaignResponse, error)
	...
	UpdateAutoAddNewProductSetting(ctx context.Context, sid uint64, req UpdateAutoAddNewProductSettingRequest, tok string) (*UpdateAutoAddNewProductSettingResponse, error)
	...
	UpdateBasicInfoOfTargetedCampaign(ctx context.Context, sid uint64, req UpdateBasicInfoOfTargetedCampaignRequest, tok string) (*UpdateBasicInfoOfTargetedCampaignResponse, error)
}
