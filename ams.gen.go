...
type AMSService interface {
	...
	AddAllProductsToOpenCampaign(sid uint64, req AddAllProductsToOpenCampaignRequest, tok string) (*AddAllProductsToOpenCampaignResponse, error)
	...
	BatchAddProductsToOpenCampaign(sid uint64, req BatchAddProductsToOpenCampaignRequest, tok string) (*BatchAddProductsToOpenCampaignResponse, error)
	...
	BatchEditProductsOpenCampaignSetting(sid uint64, req BatchEditProductsOpenCampaignSettingRequest, tok string) (*BatchEditProductsOpenCampaignSettingResponse, error)
	...
	BatchGetProductsSuggestedRate(sid uint64, opt BatchGetProductsSuggestedRateRequest, tok string) (*BatchGetProductsSuggestedRateResponse, error)
	...
	BatchRemoveProductsOpenCampaignSetting(sid uint64, req BatchRemoveProductsOpenCampaignSettingRequest, tok string) (*BatchRemoveProductsOpenCampaignSettingResponse, error)
	...
	CreateNewTargetedCampaign(sid uint64, req CreateNewTargetedCampaignRequest, tok string) (*CreateNewTargetedCampaignResponse, error)
	...
	EditAffiliateListOfTargetedCampaign(sid uint64, req EditAffiliateListOfTargetedCampaignRequest, tok string) (*EditAffiliateListOfTargetedCampaignResponse, error)
	...
	EditAllProductsOpenCampaignSetting(sid uint64, req EditAllProductsOpenCampaignSettingRequest, tok string) (*EditAllProductsOpenCampaignSettingResponse, error)
	...
	EditProductListOfTargetedCampaign(sid uint64, req EditProductListOfTargetedCampaignRequest, tok string) (*EditProductListOfTargetedCampaignResponse, error)
	...
	GetAffiliatePerformance(sid uint64, opt GetAffiliatePerformanceRequest, tok string) (*GetAffiliatePerformanceResponse, error)
	...
	GetAutoAddNewProductToggleStatus(sid uint64, tok string) (*GetAutoAddNewProductToggleStatusResponse, error)
	...
	GetCampaignKeyMetricsPerformance(sid uint64, opt GetCampaignKeyMetricsPerformanceRequest, tok string) (*GetCampaignKeyMetricsPerformanceResponse, error)
	...
	GetContentPerformance(sid uint64, opt GetContentPerformanceRequest, tok string) (*GetContentPerformanceResponse, error)
	...
	GetConversionReport(sid uint64, opt GetConversionReportRequest, tok string) (*GetConversionReportResponse, error)
	...
	GetManagedAffiliateList(sid uint64, opt GetManagedAffiliateListRequest, tok string) (*GetManagedAffiliateListResponse, error)
	...
	GetOpenCampaignAddedProduct(sid uint64, opt GetOpenCampaignAddedProductRequest, tok string) (*GetOpenCampaignAddedProductResponse, error)
	...
	GetOpenCampaignBatchTaskResult(sid uint64, opt GetOpenCampaignBatchTaskResultRequest, tok string) (*GetOpenCampaignBatchTaskResultResponse, error)
	...
	GetOpenCampaignNotAddedProduct(sid uint64, opt GetOpenCampaignNotAddedProductRequest, tok string) (*GetOpenCampaignNotAddedProductResponse, error)
	...
	GetOpenCampaignPerformance(sid uint64, opt GetOpenCampaignPerformanceRequest, tok string) (*GetOpenCampaignPerformanceResponse, error)
	...
	GetOptimizationSuggestionProduct(sid uint64, opt GetOptimizationSuggestionProductRequest, tok string) (*GetOptimizationSuggestionProductResponse, error)
	...
	GetPerformanceDataUpdateTime(sid uint64, opt GetPerformanceDataUpdateTimeRequest, tok string) (*GetPerformanceDataUpdateTimeResponse, error)
	...
	GetProductPerformance(sid uint64, opt GetProductPerformanceRequest, tok string) (*GetProductPerformanceResponse, error)
	...
	GetRecommendedAffiliateList(sid uint64, opt GetRecommendedAffiliateListRequest, tok string) (*GetRecommendedAffiliateListResponse, error)
	...
	GetShopPerformance(sid uint64, opt GetShopPerformanceRequest, tok string) (*AMSGetShopPerformanceResponse, error)
	...
	GetShopSuggestedRate(sid uint64, tok string) (*GetShopSuggestedRateResponse, error)
	...
	GetTargetedCampaignAddableProductList(sid uint64, opt GetTargetedCampaignAddableProductListRequest, tok string) (*GetTargetedCampaignAddableProductListResponse, error)
	...
	GetTargetedCampaignList(sid uint64, opt GetTargetedCampaignListRequest, tok string) (*GetTargetedCampaignListResponse, error)
	...
	GetTargetedCampaignPerformance(sid uint64, opt GetTargetedCampaignPerformanceRequest, tok string) (*GetTargetedCampaignPerformanceResponse, error)
	...
	GetTargetedCampaignSettings(sid uint64, opt GetTargetedCampaignSettingsRequest, tok string) (*GetTargetedCampaignSettingsResponse, error)
	...
	GetValidationList(sid uint64, tok string) (*GetValidationListResponse, error)
	...
	GetValidationReport(sid uint64, opt GetValidationReportRequest, tok string) (*GetValidationReportResponse, error)
	...
	QueryAffiliateList(sid uint64, opt QueryAffiliateListRequest, tok string) (*QueryAffiliateListResponse, error)
	...
	RemoveAllProductsOpenCampaignSetting(sid uint64, tok string) (*RemoveAllProductsOpenCampaignSettingResponse, error)
	...
	TerminateTargetedCampaign(sid uint64, req TerminateTargetedCampaignRequest, tok string) (*TerminateTargetedCampaignResponse, error)
	...
	UpdateAutoAddNewProductSetting(sid uint64, req UpdateAutoAddNewProductSettingRequest, tok string) (*UpdateAutoAddNewProductSettingResponse, error)
	...
	UpdateBasicInfoOfTargetedCampaign(sid uint64, req UpdateBasicInfoOfTargetedCampaignRequest, tok string) (*UpdateBasicInfoOfTargetedCampaignResponse, error)
}
...
// Path: /api/v2/ams/add_all_products_to_open_campaign
// https://open.shopee.com/documents/v2/v2.ams.add_all_products_to_open_campaign?module=127&type=1
func (s *AMSServiceOp[T]) AddAllProductsToOpenCampaign(sid uint64, req AddAllProductsToOpenCampaignRequest, tok string) (*AddAllProductsToOpenCampaignResponse, error) {
...
// Path: /api/v2/ams/batch_add_products_to_open_campaign
// https://open.shopee.com/documents/v2/v2.ams.batch_add_products_to_open_campaign?module=127&type=1
func (s *AMSServiceOp[T]) BatchAddProductsToOpenCampaign(sid uint64, req BatchAddProductsToOpenCampaignRequest, tok string) (*BatchAddProductsToOpenCampaignResponse, error) {
...
// Path: /api/v2/ams/batch_edit_products_open_campaign_setting
// https://open.shopee.com/documents/v2/v2.ams.batch_edit_products_open_campaign_setting?module=127&type=1
func (s *AMSServiceOp[T]) BatchEditProductsOpenCampaignSetting(sid uint64, req BatchEditProductsOpenCampaignSettingRequest, tok string) (*BatchEditProductsOpenCampaignSettingResponse, error) {
...
// Path: /api/v2/ams/batch_get_products_suggested_rate
// https://open.shopee.com/documents/v2/v2.ams.batch_get_products_suggested_rate?module=127&type=1
func (s *AMSServiceOp[T]) BatchGetProductsSuggestedRate(sid uint64, opt BatchGetProductsSuggestedRateRequest, tok string) (*BatchGetProductsSuggestedRateResponse, error) {
...
// Path: /api/v2/ams/batch_remove_products_open_campaign_setting
// https://open.shopee.com/documents/v2/v2.ams.batch_remove_products_open_campaign_setting?module=127&type=1
func (s *AMSServiceOp[T]) BatchRemoveProductsOpenCampaignSetting(sid uint64, req BatchRemoveProductsOpenCampaignSettingRequest, tok string) (*BatchRemoveProductsOpenCampaignSettingResponse, error) {
...
// Path: /api/v2/ams/create_new_targeted_campaign
// https://open.shopee.com/documents/v2/v2.ams.create_new_targeted_campaign?module=127&type=1
func (s *AMSServiceOp[T]) CreateNewTargetedCampaign(sid uint64, req CreateNewTargetedCampaignRequest, tok string) (*CreateNewTargetedCampaignResponse, error) {
...
// Path: /api/v2/ams/edit_affiliate_list_of_targeted_campaign
// https://open.shopee.com/documents/v2/v2.ams.edit_affiliate_list_of_targeted_campaign?module=127&type=1
func (s *AMSServiceOp[T]) EditAffiliateListOfTargetedCampaign(sid uint64, req EditAffiliateListOfTargetedCampaignRequest, tok string) (*EditAffiliateListOfTargetedCampaignResponse, error) {
...
// Path: /api/v2/ams/edit_all_products_open_campaign_setting
// https://open.shopee.com/documents/v2/v2.ams.edit_all_products_open_campaign_setting?module=127&type=1
func (s *AMSServiceOp[T]) EditAllProductsOpenCampaignSetting(sid uint64, req EditAllProductsOpenCampaignSettingRequest, tok string) (*EditAllProductsOpenCampaignSettingResponse, error) {
...
// Path: /api/v2/ams/edit_product_list_of_targeted_campaign
// https://open.shopee.com/documents/v2/v2.ams.edit_product_list_of_targeted_campaign?module=127&type=1
func (s *AMSServiceOp[T]) EditProductListOfTargetedCampaign(sid uint64, req EditProductListOfTargetedCampaignRequest, tok string) (*EditProductListOfTargetedCampaignResponse, error) {
...
// Path: /api/v2/ams/get_affiliate_performance
// https://open.shopee.com/documents/v2/v2.ams.get_affiliate_performance?module=127&type=1
func (s *AMSServiceOp[T]) GetAffiliatePerformance(sid uint64, opt GetAffiliatePerformanceRequest, tok string) (*GetAffiliatePerformanceResponse, error) {
...
// Path: /api/v2/ams/get_auto_add_new_product_toggle_status
// https://open.shopee.com/documents/v2/v2.ams.get_auto_add_new_product_toggle_status?module=127&type=1
func (s *AMSServiceOp[T]) GetAutoAddNewProductToggleStatus(sid uint64, tok string) (*GetAutoAddNewProductToggleStatusResponse, error) {
...
// Path: /api/v2/ams/get_campaign_key_metrics_performance
// https://open.shopee.com/documents/v2/v2.ams.get_campaign_key_metrics_performance?module=127&type=1
func (s *AMSServiceOp[T]) GetCampaignKeyMetricsPerformance(sid uint64, opt GetCampaignKeyMetricsPerformanceRequest, tok string) (*GetCampaignKeyMetricsPerformanceResponse, error) {
...
// Path: /api/v2/ams/get_content_performance
// https://open.shopee.com/documents/v2/v2.ams.get_content_performance?module=127&type=1
func (s *AMSServiceOp[T]) GetContentPerformance(sid uint64, opt GetContentPerformanceRequest, tok string) (*GetContentPerformanceResponse, error) {
...
// Path: /api/v2/ams/get_conversion_report
// https://open.shopee.com/documents/v2/v2.ams.get_conversion_report?module=127&type=1
func (s *AMSServiceOp[T]) GetConversionReport(sid uint64, opt GetConversionReportRequest, tok string) (*GetConversionReportResponse, error) {
...
// Path: /api/v2/ams/get_managed_affiliate_list
// https://open.shopee.com/documents/v2/v2.ams.get_managed_affiliate_list?module=127&type=1
func (s *AMSServiceOp[T]) GetManagedAffiliateList(sid uint64, opt GetManagedAffiliateListRequest, tok string) (*GetManagedAffiliateListResponse, error) {
...
// Path: /api/v2/ams/get_open_campaign_added_product
// https://open.shopee.com/documents/v2/v2.ams.get_open_campaign_added_product?module=127&type=1
func (s *AMSServiceOp[T]) GetOpenCampaignAddedProduct(sid uint64, opt GetOpenCampaignAddedProductRequest, tok string) (*GetOpenCampaignAddedProductResponse, error) {
...
// Path: /api/v2/ams/get_open_campaign_batch_task_result
// https://open.shopee.com/documents/v2/v2.ams.get_open_campaign_batch_task_result?module=127&type=1
func (s *AMSServiceOp[T]) GetOpenCampaignBatchTaskResult(sid uint64, opt GetOpenCampaignBatchTaskResultRequest, tok string) (*GetOpenCampaignBatchTaskResultResponse, error) {
...
// Path: /api/v2/ams/get_open_campaign_not_added_product
// https://open.shopee.com/documents/v2/v2.ams.get_open_campaign_not_added_product?module=127&type=1
func (s *AMSServiceOp[T]) GetOpenCampaignNotAddedProduct(sid uint64, opt GetOpenCampaignNotAddedProductRequest, tok string) (*GetOpenCampaignNotAddedProductResponse, error) {
...
// Path: /api/v2/ams/get_open_campaign_performance
// https://open.shopee.com/documents/v2/v2.ams.get_open_campaign_performance?module=127&type=1
func (s *AMSServiceOp[T]) GetOpenCampaignPerformance(sid uint64, opt GetOpenCampaignPerformanceRequest, tok string) (*GetOpenCampaignPerformanceResponse, error) {
...
// Path: /api/v2/ams/get_optimization_suggestion_product
// https://open.shopee.com/documents/v2/v2.ams.get_optimization_suggestion_product?module=127&type=1
func (s *AMSServiceOp[T]) GetOptimizationSuggestionProduct(sid uint64, opt GetOptimizationSuggestionProductRequest, tok string) (*GetOptimizationSuggestionProductResponse, error) {
...
// Path: /api/v2/ams/get_performance_data_update_time
// https://open.shopee.com/documents/v2/v2.ams.get_performance_data_update_time?module=127&type=1
func (s *AMSServiceOp[T]) GetPerformanceDataUpdateTime(sid uint64, opt GetPerformanceDataUpdateTimeRequest, tok string) (*GetPerformanceDataUpdateTimeResponse, error) {
...
// Path: /api/v2/ams/get_product_performance
// https://open.shopee.com/documents/v2/v2.ams.get_product_performance?module=127&type=1
func (s *AMSServiceOp[T]) GetProductPerformance(sid uint64, opt GetProductPerformanceRequest, tok string) (*GetProductPerformanceResponse, error) {
...
// Path: /api/v2/ams/get_recommended_affiliate_list
// https://open.shopee.com/documents/v2/v2.ams.get_recommended_affiliate_list?module=127&type=1
func (s *AMSServiceOp[T]) GetRecommendedAffiliateList(sid uint64, opt GetRecommendedAffiliateListRequest, tok string) (*GetRecommendedAffiliateListResponse, error) {
...
// Path: /api/v2/ams/get_shop_performance
// https://open.shopee.com/documents/v2/v2.ams.get_shop_performance?module=127&type=1
func (s *AMSServiceOp[T]) GetShopPerformance(sid uint64, opt GetShopPerformanceRequest, tok string) (*AMSGetShopPerformanceResponse, error) {
...
// Path: /api/v2/ams/get_shop_suggested_rate
// https://open.shopee.com/documents/v2/v2.ams.get_shop_suggested_rate?module=127&type=1
func (s *AMSServiceOp[T]) GetShopSuggestedRate(sid uint64, tok string) (*GetShopSuggestedRateResponse, error) {
...
// Path: /api/v2/ams/get_targeted_campaign_addable_product_list
// https://open.shopee.com/documents/v2/v2.ams.get_targeted_campaign_addable_product_list?module=127&type=1
func (s *AMSServiceOp[T]) GetTargetedCampaignAddableProductList(sid uint64, opt GetTargetedCampaignAddableProductListRequest, tok string) (*GetTargetedCampaignAddableProductListResponse, error) {
...
// Path: /api/v2/ams/get_targeted_campaign_list
// https://open.shopee.com/documents/v2/v2.ams.get_targeted_campaign_list?module=127&type=1
func (s *AMSServiceOp[T]) GetTargetedCampaignList(sid uint64, opt GetTargetedCampaignListRequest, tok string) (*GetTargetedCampaignListResponse, error) {
...
// Path: /api/v2/ams/get_targeted_campaign_performance
// https://open.shopee.com/documents/v2/v2.ams.get_targeted_campaign_performance?module=127&type=1
func (s *AMSServiceOp[T]) GetTargetedCampaignPerformance(sid uint64, opt GetTargetedCampaignPerformanceRequest, tok string) (*GetTargetedCampaignPerformanceResponse, error) {
...
// Path: /api/v2/ams/get_targeted_campaign_settings
// https://open.shopee.com/documents/v2/v2.ams.get_targeted_campaign_settings?module=127&type=1
func (s *AMSServiceOp[T]) GetTargetedCampaignSettings(sid uint64, opt GetTargetedCampaignSettingsRequest, tok string) (*GetTargetedCampaignSettingsResponse, error) {
...
// Path: /api/v2/ams/get_validation_list
// https://open.shopee.com/documents/v2/v2.ams.get_validation_list?module=127&type=1
func (s *AMSServiceOp[T]) GetValidationList(sid uint64, tok string) (*GetValidationListResponse, error) {
...
// Path: /api/v2/ams/get_validation_report
// https://open.shopee.com/documents/v2/v2.ams.get_validation_report?module=127&type=1
func (s *AMSServiceOp[T]) GetValidationReport(sid uint64, opt GetValidationReportRequest, tok string) (*GetValidationReportResponse, error) {
...
// Path: /api/v2/ams/query_affiliate_list
// https://open.shopee.com/documents/v2/v2.ams.query_affiliate_list?module=127&type=1
func (s *AMSServiceOp[T]) QueryAffiliateList(sid uint64, opt QueryAffiliateListRequest, tok string) (*QueryAffiliateListResponse, error) {
...
// Path: /api/v2/ams/remove_all_products_open_campaign_setting
// https://open.shopee.com/documents/v2/v2.ams.remove_all_products_open_campaign_setting?module=127&type=1
func (s *AMSServiceOp[T]) RemoveAllProductsOpenCampaignSetting(sid uint64, tok string) (*RemoveAllProductsOpenCampaignSettingResponse, error) {
...
// Path: /api/v2/ams/terminate_targeted_campaign
// https://open.shopee.com/documents/v2/v2.ams.terminate_targeted_campaign?module=127&type=1
func (s *AMSServiceOp[T]) TerminateTargetedCampaign(sid uint64, req TerminateTargetedCampaignRequest, tok string) (*TerminateTargetedCampaignResponse, error) {
...
// Path: /api/v2/ams/update_auto_add_new_product_setting
// https://open.shopee.com/documents/v2/v2.ams.update_auto_add_new_product_setting?module=127&type=1
func (s *AMSServiceOp[T]) UpdateAutoAddNewProductSetting(sid uint64, req UpdateAutoAddNewProductSettingRequest, tok string) (*UpdateAutoAddNewProductSettingResponse, error) {
...
// Path: /api/v2/ams/update_basic_info_of_targeted_campaign
// https://open.shopee.com/documents/v2/v2.ams.update_basic_info_of_targeted_campaign?module=127&type=1
func (s *AMSServiceOp[T]) UpdateBasicInfoOfTargetedCampaign(sid uint64, req UpdateBasicInfoOfTargetedCampaignRequest, tok string) (*UpdateBasicInfoOfTargetedCampaignResponse, error) {
