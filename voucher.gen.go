...
type VoucherService interface {
	...
	AddVoucher(ctx context.Context, sid uint64, req AddVoucherRequest, tok string) (*AddVoucherResponse, error)
	...
	DeleteVoucher(ctx context.Context, sid uint64, req DeleteVoucherRequest, tok string) (*DeleteVoucherResponse, error)
	...
	EndVoucher(ctx context.Context, sid uint64, req EndVoucherRequest, tok string) (*EndVoucherResponse, error)
	...
	GetVoucher(ctx context.Context, sid uint64, req GetVoucherRequest, tok string) (*GetVoucherResponse, error)
	...
	GetVoucherList(ctx context.Context, sid uint64, req GetVoucherListRequest, tok string) (*GetVoucherListResponse, error)
	...
	UpdateVoucher(ctx context.Context, sid uint64, req UpdateVoucherRequest, tok string) (*UpdateVoucherResponse, error)
}
