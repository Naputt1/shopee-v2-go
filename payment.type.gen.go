...
type ItemsPromotion struct {
	...
	PromotionId   uint64 `json:"promotion_id"`   // [Required] <p>Represents the unique identifier of a specific promotion applied to an item. Each promotion_id corresponds to a distinct promotion rule or campaign, defined under a particular promotion_type.&nbsp;</p>
}
...
type OrderIncomeItems struct {
	...
	ActivityId                uint64           `json:"activity_id"`                  // [Required] <p>If bundle_deal the is id of bundle deal, if add_on_deal this is id of add on deal.</p>
